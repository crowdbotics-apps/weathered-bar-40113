"""
Django settings for weathered_bar_40113 project.
...
ROOT_URLCONF = 'weathered_bar_40113.urls'
...
WSGI_APPLICATION = 'weathered_bar_40113.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "weathered_bar_40113 API",
    "DESCRIPTION": "API documentation for weathered_bar_40113 App",
    "VERSION": "v1",
}
